...
public class PlayerLedgeClimbState : PlayerState
{
    ...
    private Vector2 DetermineCornerPosition()
    {
        ...
        RaycastHit2D yHit = Physics2D.Raycast(core.CollisionSenses.LedgeCheckHorizontal.position + (Vector3)(workspace), Vector3.down, core.CollisionSenses.LedgeCheckHorizontal.position.y - core.CollisionSenses.WallCheck.position.y + 0.015f, playerData.whatIsGround);
